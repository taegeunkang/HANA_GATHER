    ...
    if (
      ...
      if (response['status'] == 200) {
        ...
        navigation.navigate('Congraturation', {
          ...
          description: t('complete.subTitle'),
          destination: 'Login',
        });
      } else {
        response = await response.json();
    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.contentsBox}>
            ...
            <>
              ...
              >
                <View>
                  ...
                  >
                    <Text
                      style={[Fonts.inputHeader, { color: Colors.textBold }]}
                    >
                      {'인증코드 입력'}
                    </Text>
                  </View>
          ...
          {wrongPasswordReg && (
            <View
              style={{ width: responsiveWidth(370), alignItems: 'flex-start' }}
            >
              <Text
                style={[
                  {
